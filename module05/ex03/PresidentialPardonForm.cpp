...
/*   Updated: 2023/11/27 15:09:53 by hait-hsa         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
PresidentialPardonForm::PresidentialPardonForm( std::string target ) : name("Presidential reque"), isSigned(false), signGrade(25), executeGrade(5), target(target) {}
